...
work against the published package (`starforge-cli@0.5.1`). This variant needs
...
shasum -a 1 /tmp/sfpack/starforge-cli-0.5.1.tgz                     # equals the printed shasum (SHA-1)
openssl dgst -sha512 -binary /tmp/sfpack/starforge-cli-0.5.1.tgz | base64
                                                   # equals the printed integrity, minus "sha512-"
tar -xzf /tmp/sfpack/starforge-cli-0.5.1.tgz -C /tmp/sfpack
